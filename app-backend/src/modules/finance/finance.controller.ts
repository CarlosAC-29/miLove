...
export const financeController = {
  async listTransactions(request: Request, response: Response) {
    ...
    const data = await financeService.listTransactions(request.auth!.sub, context);
  ...
  async listBudgets(request: Request, response: Response) {
    const context = financeContextSchema.parse(request.query.context);
    const data = await financeService.listBudgets(request.auth!.sub, context);
    return response.json(data);
  },
  ...
  async summary(request: Request, response: Response) {
    const context = financeContextSchema.parse(request.query.context);
    const data = await financeService.getSummary(request.auth!.sub, context);
    return response.json(data);
  },
  ...
  async insights(request: Request, response: Response) {
    ...
    const data = await financeService.getInsights(request.auth!.sub, context);
    return response.json(data);
  },
};
